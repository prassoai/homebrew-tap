class Murmur < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/prassoai/murmuration/releases/download/v0.1.2/murmur-darwin-amd64"
      sha256 "bf7e688f491e6fe834aba8c07a9472bab081a70b61b2e959a77dcc23540c643b"
    end
    on_arm do
      url "https://github.com/prassoai/murmuration/releases/download/v0.1.2/murmur-darwin-arm64"
  ...
  on_linux do
    on_intel do
      url "https://github.com/prassoai/murmuration/releases/download/v0.1.2/murmur-linux-amd64"
